...
$t = ".coletiva.[br/]$pmtou [br/][br/]Coletiva EstaçãoWAP, Responda em caso de dúvida!";
}
else if($para=="equipe")
{
...
//log
$msg = "%$uid% enviou um Coletiva EstaçãoWAP para ".strtoupper($para)."!";
addlog($msg);
...
echo "<br />";
echo " - Nunca dê status para ninguém sem consultar a equipe em geral, verifique sempre se o usuário se destaca no site!";
echo "<br />";
...
echo "<a href=\"modcp.php?action=rtp&sid=$sid\">&#187;Tópicos($nrtp[0])</a><br>";
