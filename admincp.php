...
{
echo "<img src=\"images/notok.gif\" alt=\"\">Não foi possível adicionar a palavra!";
}
else
{
...
echo "<option value=\"5\">Amor/Emoçoes</option>";
...
{
$msg = "%$uid% está alterando as configuraçoes do site!";
addlog($msg);
$xtm = getsxtm();
$paf = flood_torpedos();
$fvw = flood_forum();
...
{
$msg = "%$uid% está alterando as categorias do fórum!";
addlog($msg);
echo "<p align=\"center\">";
...
{
$msg = "%$uid% está alterando as sub. cats do fórum!";
addlog($msg);
echo "<p align=\"center\">";
...
{
$msg = "%$uid% está adicionando uma nova categoria no fórum do site!";
addlog($msg);
echo "<p align=\"center\">";
echo "<b>Adicionar Categoria</b><br/><br/>";
echo "O campo <b>posiçao</b> vai alterar nas <b>posiçoes reais dos tópicos</b>, para baixo ou cima!";
echo "<br />";
echo "<br />";
...
$max_id = $max_id[0] + 1;
echo "Posiçao: <input name=\"fcpos\" format=\"*N\" size=\"3\" value=\"$max_id\" maxlength=\"3\"/><br/>";
...
echo "Posiçao: <input name=\"frpos\" format=\"*N\" size=\"3\"  maxlength=\"3\"/><br/>";
...
echo "Permiçao: <select name=\"chrprm\">";
...
addlog($msg);
echo "<p align=\"center\">";
echo "<b>Editar sub cat do Fórum</b><br/><br/>";
...
echo "</select><br/>";
echo "Titúlo: <input name=\"fcname\" maxlength=\"30\"/><br/>";
echo "Posiçao: <input name=\"fcpos\" format=\"*N\" size=\"3\"  maxlength=\"3\"/><br/>";
echo "<input type=\"submit\" value=\"Editar\"/>";
echo "</form>";
